...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "ZEON_seeder\n"
...
static const string mainnet_seeds[] = {"45.77.137.85" ,"178.128.245.39" ,"dnsseed1.zeonhexalgo.fun" , "dnsseed2.zeonhexalgo.fun" ,  "94.177.241.188" , "5.249.155.15" ,"167.99.47.128." , ""};
